...
public class LoadingManager : MonoBehaviour {
    ...
    public static AsyncOperation _loadingAsyncOperation;
    ...
    void Awake()
    {
        ...
        StartCoroutine(LoadSceneAsync(SceneToLoadIdx));
    }
    ...
    {  
        ...
        _loadingAsyncOperation = SceneManager.LoadSceneAsync(sceneIdx);  //Load the chosen scene in the background while displaying progress on the slider
        ...
        yield return StartCoroutine(Fade(LoadingSceneFadeOverlay, FadeDuration, true)); //fade into black once loading is complete and the slider is full
         ...
         //need this since the regular scene loaded callback doesn't work with async
